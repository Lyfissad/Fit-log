...
export default function Login(){
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        function switchShow(){              //password hide icon state
        ...
        const buttonState = loading? <AiOutlineLoading3Quarters 
                className="fill-text-pri relative z-50 items-center justify-center size-5 mx-auto animate-spin"/> : "Login" //button loading
        ...
        <div className="bg-grayBlack h-screen w-full pt-5 animate-fadeIn">
            ...
            <button className="w-[20rem] h-[3rem] cursor-pointer rounded-lg bg-priAccent mx-auto">{buttonState}</button>
            </form>
        </div>
    )
}