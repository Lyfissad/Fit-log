    ...
    return(
        <footer className="fixed bottom-0 left-0 w-full">
          <ul className="flex bg-[#1C1C1E] border-t border-[#2C2C2E] justify-center text-sm h-[4rem]">
            ...
            <li onClick={() => {setActiveTab("history")}} className={`px-3 min-w-18 transition-all duration-250 ${activeTab === "history"? "text-text-pri" : "text-text-sec"}`}>
              <Link href={"/history"}>
              <FaHistory className={`size-7 mx-auto my-1 transition-all duration-250 ${activeTab === "history"? "text-text-pri" : "text-text-sec"}`}/>
              History
              </Link>
            </li>
            <li onClick={() => {setActiveTab("work")}} className={`px-3 min-w-18 transition-all duration-250 ${activeTab === "work"? "text-text-pri" : "text-text-sec"}`}>
              <Link href={"/"}>
              <IoMdAdd className={`size-7 mx-auto my-1 transition-all duration-250 ${activeTab === "work"? "text-text-pri" : "text-text-sec"}`}/>
              Workouts
              </Link>
            </li>
            <li onClick={() => {setActiveTab("exercise")}} className={`px-3 min-w-18 transition-all duration-250 ${activeTab === "exercise"? "text-text-pri" : "text-text-sec"}`}>
            ...
            <li onClick={() => {setActiveTab("measure")}} className={`px-3 min-w-18 transition-all duration-250 ${activeTab === "measure"? "text-text-pri" : "text-text-sec"}`}>
              <Link href={"/measure"}>
